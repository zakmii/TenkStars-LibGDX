...
public class GamePauseScreen implements Screen, Disposable {
    ...
    TenkStars game;
    public GamePauseScreen(final TenkStars game) {
        this.game=game;
        ...
        buttonMainMenu = new TextButton("SAVE", textButtonStyle);
        ...
        table.getCell(buttonMainMenu).spaceBottom(15);
        table.row();
